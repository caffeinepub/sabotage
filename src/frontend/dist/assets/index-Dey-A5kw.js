  ...
  reactExports.useEffect(() => {
    ...
    function updatePhysics() {
      ...
      if (reportBtnRef.current) {
        ...
        reportBtnRef.current.style.transform = nearby ? "scale(1.05)" : "scale(1)";
      }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    ...
                    color: "#0f0",
                    background: "linear-gradient(90deg, transparent, rgba(0,50,0,0.8), transparent)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    ...
                    height: 100,
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(255,0,0,0.3), rgba(100,0,0,0.8))",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  style: {
                    ...
                    height: 90,
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(255,165,0,0.3), rgba(100,60,0,0.8))",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              width: "100%",
              height: "100%",
              background: "linear-gradient(135deg, #000 0%, #0a1a0a 50%, #000 100%)",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 16, justifyContent: "center" }, children: Object.values(MAPS).map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      padding: "14px 22px",
                      minWidth: 160,
                      background: selectedMap === m.id ? "rgba(0,255,0,0.18)" : "transparent",
                      color: selectedMap === m.id ? "#0f0" : "#0a0",
                      border: selectedMap === m.id ? "2px solid #0f0" : "2px solid #050",
                      cursor: "pointer",
                      fontFamily: "'Impact', 'Arial Black', sans-serif",
                      fontSize: 15,
                      letterSpacing: 3,
                      ...
                      textAlign: "left",
                      transition: "all 0.2s",
                      boxShadow: selectedMap === m.id ? "0 0 20px rgba(0,255,0,0.3)" : "none"
                    },
                    children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 20, marginBottom: 20 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    onMouseLeave: (e) => {
                      e.target.style.borderColor = "#050";
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onMouseEnter: (e) => {
                    e.target.style.borderColor = "#8888cc";
                    e.target.style.color = "#fff";
                  },
                  onMouseLeave: (e) => {
                    e.target.style.borderColor = "#3a3a6e";
                    e.target.style.color = "#aab0d4";
                  },
                  children: "← BACK"
                }
              )
